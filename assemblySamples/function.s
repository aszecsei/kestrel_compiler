...
@ options passed:  -imultilib . -imultiarch arm-linux-gnueabihf function.c
...
myfunc:
	...
	ldr	r1, [fp, #-8]	@, i
	bl	printf	@
	ldr	r2, [fp, #-8]	@ tmp112, i
	mov	r3, r2	@ tmp113, tmp112
	mov	r3, r3, asl #2	@ tmp113, tmp113,
	add	r3, r3, r2	@ tmp113, tmp113, tmp112
	mov	r3, r3, asl #2	@ tmp114, tmp113,
	mov	r0, r3	@, <retval>
	sub	sp, fp, #4	@,,
	@ sp needed	@
	ldmfd	sp!, {fp, pc}	@
